...
<div class="container">
    <div class="d-flex">
        ...
        <div class="col-6">
            <my-maps latitude={{$lat}} longitude={{$lng}} typeofshow={{$typeofshow}} tomtomkey={{env('TOMTOM_API_KEY')}}>
            </my-maps>
        </div>
...
<div class="row d-flex justify-content-around">
    ...
    <div><button type="button" class="btn btn-primary"><a href="{{ route('user.structures.edit', $structure->id) }}" class="text-light">Modifica</a></button>
    </div>
    <div class="">
